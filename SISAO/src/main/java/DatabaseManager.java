...
public class DatabaseManager {
    ...
    public void boot() {
        ...
        if (!dbExists) {
            ...
            CourseCVSlines.removeFirst(); // Removing the Headers of the CVS file Course;TimeToStart;DurationInLectureHours;Lecturer;Students;;;;;;
            ...
            File classroomFile = new File("ClassroomCapacity.csv");
            try {
